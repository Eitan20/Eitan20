...
export default function GeneratorSimple() {
	...
	async function handleCreateArticle() {
		...
		if (mock) {
			...
			request = gptWrapper.WriteArticle_(
				kw, articleStyle, articleLengthSlider, headerInput, keywordMultiInput, updateArticleProgress)
		}
		else {
			console.error(`Unrecognized article mode: ${mode}`)
		}
